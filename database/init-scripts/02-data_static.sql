...
-- Insert data into selection
INSERT INTO selection (name,mangaName) VALUES
 ('Selection','Attaque des titans'),('Selection','Berserk'),('Selection','Bleach'),('Selection','Dragon Ball'),('Selection','Dragon Ball Super'),('Selection','Fairy Tail'),('Selection','Naruto'),('Selection','One Piece') ON CONFLICT (name,mangaName) DO NOTHING;
