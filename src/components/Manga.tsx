    ...
    function Modal() {
        return createPortal(
          <StyledDiv background='rgba(0,0,0,0.75)'
            ...
            >
              <div
                className={`bg-background  p-10 flex flex-col  w-3/5  max-h-screen overflow-y-auto origin-top-left mt-20  z-4 ${
